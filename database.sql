第一步：创建数据库，如netease
create database netease default charset utf8 collate utf8_general_ci;

第二步：使用数据库
use netease

第三步：创建用户与密码，如netease netease@2018
create user netease@localhost identified by 'netease@2018';

第四步：授权用户
grant select,update,insert,delete on netease.* to netease@localhost identified by 'netease@2018';
...
第六步：添加表数据
INSERT INTO `netease_userinfo` VALUES (1,'buyer','37254660e226ea65ce6f1efd54233424','2018-03-20',1),(2,'seller','981c57a5cfb0f868e064904b8745766f','2018-03-20',2);
