			...
			<div class="top-header-main">					
				<div class="col-md-6 top-header-left">
					...
					<div class="box">
						...
						<select id="userrole" class="dropdown drop" onchange="self.location.href=options[selectedIndex].value">
							...
							<option value="${pageContext.request.contextPath}/shoppingCart/cart">我的购物车</option>
						</select>
						</c:if>
				...
				<div class="col-md-6 top-header-right">
					<div class="cart box_1">
						...
						<a href="${pageContext.request.contextPath}/shoppingCart/cart">
							<img src="${imagesPath}/cart.png" alt="" />
							<div class="total">							
							</div>
						</a>
...
<script type="text/javascript">
 	...
 	function getCartCount(){
		$.ajax({
			type: "GET",
			dataType: "json",
			url:"${pageContext.request.contextPath}/shoppingCart/countCartGoods",
